class Slate {
    ...
    constructor(pen) {
        // Récupération du <canvas>  (initialisation de la propriété canvas)
        this.canvas = document.getElementById('slate'); 
        // Récupération du contexte du canvas  (initialisation de la propriété context)
        this.context = this.canvas.getContext('2d');  
        // Au début on ne sait pas où se trouve la souris  (initialisation de la propriété currentLocation)
        this.currentLocation = null;
        // Au début on ne dessine pas (initialisation de la propriété isDrawing)
        this.isDrawing = false;
        // Stockage de l'objet crayon  (initialisation de la propriété pen)
        this.pen = pen;
        
        // Installation des gestionnaires d'évènements de l'ardoise. (4)
