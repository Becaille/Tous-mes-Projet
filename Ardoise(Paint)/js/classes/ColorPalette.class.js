class ColorPalette {
    ...
    constructor() {
        ...
        //initialisation de la couleur rgb
    ...
    build() {
        //création d'un gradiant lineaire avec canvas sur l'horizontal createLinearGradient
        ...
        //application à la fill
        this.context.fillStyle = gradient;
        //création du carré
        this.context.fillRect(0, 0, this.canvas.width, this.canvas.height);
        
        //création d'un gradiant lineaire avec canvas sur la verticale
    ...
    onClick(event) {
         ...
         * lequel l'utilisateur a cliqué. (getImageData)
         */
