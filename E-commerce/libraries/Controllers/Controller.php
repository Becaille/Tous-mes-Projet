...
abstract class Controller
{
    ...
    if (!empty($this->modelName)) {
            ...
            $chemin = str_replace("\\", "/", "libraries/{$this->modelName}.php");
        ...
        */
        ...
        //###recupération de la liste des rayons
            //creation de l'instance du model
            $ProdLineModel = new \Models\ProductLine();
            
            //ajouter la liste des rayons à ma propriété qui contient toutes les valeurs par default mplate
            
            //merge le tableau $this->tplVars avec le tableau qui contient les rayons
            $this->tplVars = $this->tplVars + ['productLines' => $ProdLineModel->findAll()];
   
        //### chemin absolue du projet
        //$tplVars['WWW_URL'] = WWW_URL;
        
        $this->tplVars = $this->tplVars + ['WWW_URL' => WWW_URL];
        
        //isArticle
        $this->tplVars = $this->tplVars + ['isArticle' => false];
