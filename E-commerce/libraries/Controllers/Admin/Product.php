...
class Product extends \Controllers\Admin
{
   protected $modelName = \Models\Product::class;
   
   protected $nameCrud = "Product";
   
   protected $pageTitle = "Gestion des produits";
   ...
   public function index() {
           ...
           //titre de la page
            ...
            //liste des données
            $this->tplVars = $this->tplVars + [
                'list' => $this->model->findAllWithProductLine()
            ];
    ...
    public function update(array $data=[])
    {
            ...
            )
       {
        ...
        if (!empty($_FILES['product_photo_1_mini']['name']) && 
